config = dict(
    ...
    experiment='arc2',  # Experiment - either qgen or dialogue or arc
    ...
    decoder_num_tokens=10,  # Number of words/tokens in the generated sequence, 30 for qgen, 5 for arc
    ...
    load_checkpoint=24,  # Specify the trained model epoch/checkpoint number to be loaded for evaluation on test set, 0 means last saved checkpoint
